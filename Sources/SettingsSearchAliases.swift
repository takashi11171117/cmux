...
enum SettingsSearchAliasIndex {
    ...
    private static let settingAliases: [String: String] = [
        ...
        "app:file-editor-syntax-highlight": localized("settings.search.alias.setting.app.file-editor-syntax-highlight", defaultValue: "fileEditor.syntaxHighlight syntax highlight highlighting color colour keywords strings comments code source grammar editor preview"),
        "app:file-editor-line-numbers": localized("settings.search.alias.setting.app.file-editor-line-numbers", defaultValue: "fileEditor.lineNumbers line numbers ruler gutter margin numbering editor preview"),
