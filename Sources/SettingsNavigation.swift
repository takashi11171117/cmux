...
enum SettingsSearchIndex {
    ...
    private static let settingEntries: [SettingsSearchEntry] = [
        ...
        setting(.app, "file-editor-syntax-highlight", String(localized: "settings.app.fileEditorSyntaxHighlight", defaultValue: "Syntax Highlighting"), "fileEditor.syntaxHighlight syntax highlight highlighting color colour keywords strings comments code source grammar editor preview"),
        setting(.app, "file-editor-line-numbers", String(localized: "settings.app.fileEditorLineNumbers", defaultValue: "Line Numbers"), "fileEditor.lineNumbers line numbers ruler gutter margin numbering editor preview"),
    ...
    private static let settingsPathAnchorIDs: [String: String] = [
        ...
        "fileEditor.syntaxHighlight": settingID(for: .app, idSuffix: "file-editor-syntax-highlight"),
