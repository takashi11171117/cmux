...
extension Array where Element == CuratedSettingEntry {
    ...
    public static var cmuxDefault: [CuratedSettingEntry] {
        [
            ...
            .init(section: .app, id: "file-editor-syntax-highlight", title: "Syntax Highlighting", synonyms: "fileEditor.syntaxHighlight syntax highlight highlighting color colour keywords strings comments code source grammar editor preview"),
            .init(section: .app, id: "file-editor-line-numbers", title: "Line Numbers", synonyms: "fileEditor.lineNumbers line numbers ruler gutter margin numbering editor preview"),
